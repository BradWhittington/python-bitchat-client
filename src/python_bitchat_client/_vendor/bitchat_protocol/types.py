...
class MessageType(IntEnum):
    ...
    NOISE_ENCRYPTED = (
        0x11  # Noise-encrypted payload — all private messages, receipts, etc.
    )
...
class AnnouncementPacket:
    ...
    direct_neighbors: Optional[list[bytes]] = (
        None  # Up to 10 direct BLE neighbor peer IDs (8 bytes each).
    )
